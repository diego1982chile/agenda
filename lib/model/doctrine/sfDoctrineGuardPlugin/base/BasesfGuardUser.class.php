 ...
 * @property Doctrine_Collection $DiaNoLaboral
 ...
 * @method Doctrine_Collection   getDiaNoLaboral()          Returns the current record's "DiaNoLaboral" collection
 ...
 * @method sfGuardUser           setDiaNoLaboral()          Sets the current record's "DiaNoLaboral" collection
 * @method sfGuardUser           setSolicitudLicencia()     Sets the current record's "SolicitudLicencia" collection
 * 
 * @package    agenda
 * @subpackage model
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('DiaNoLaboral', array(
             'local' => 'id',
             'foreign' => 'user_id'));
